...
.sidebar {
    background-color: #004a99; padding: 20px 15px !important; color: white; min-width: 280px; max-width: 320px;
    border-right: 1px solid #dee2e6; display: flex; flex-direction: column; gap: 15px;
}
...
.chat-area {
    background-color: #f8f9fa; padding: 0 20px !important; display: flex; flex-direction: column; height: 100vh; box-sizing: border-box;
}
#chatbot {
    flex-grow: 1; overflow-y: auto; background-color: transparent; border: none !important;
    box-shadow: none !important; padding: 20px 0;
}
...
.suggestion-btn {
    background-color: #e7f1ff !important; color: #0056b3 !important; border-radius: 20px !important; border: 1px solid #cce0ff !important;
    padding: 6px 14px !important; font-size: 0.9rem !important; font-weight: 500 !important; min-height: 0 !important;
}
.suggestion-btn:hover { background-color: #d0e0ff !important; }
.input-container {
    background-color: white; border-radius: 12px; padding: 8px !important; box-shadow: 0 2px 8px rgba(0,0,0,0.08);
    border: 1px solid #dee2e6; display: flex; align-items: center; /* ИСПРАВЛЕНО: Добавлено выравнивание */
}
...
.input-container .gradio-button {
    background-color: #007bff !important; color: white !important; min-width: 100px !important;
...
with gr.Blocks(css=custom_css) as interface:
    ...
    with gr.Row(elem_classes="main-container"):
        ...
        with gr.Column(scale=4, elem_classes="chat-area"):
            # ИЗМЕНЕНО: Убраны устаревшие аргументы, добавлен type="messages"
            ...
            with gr.Column(elem_classes="input-section"):
                ...
                # ИСПРАВЛЕНО: убран неверный аргумент vertical_align
