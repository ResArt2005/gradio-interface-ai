...
from bindings.binds.user_settings import open_settings_panel_btn, fio_change_btn, email_change_btn, password_change_btn, on_avatar_change_btn, back_to_main_panel_btn
